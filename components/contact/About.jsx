            ...
            <div className="box-contact">
              <div className="heading-section mb-48">
                <h2 className="title split-text split-lines-transform">
                  {`Providing the most suitable and quality real estate guidance in ${siteContent.agent.location}.`}
                </h2>
                <p className="text-1">
                  {siteContent.contactPage.aboutDescription}
                </p>
              </div>
